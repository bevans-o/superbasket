            ...
            <div className="panel insights">
              ...
              <div className="insights__macros">
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).sodium}mg of sodium</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).sugar}g of sugar</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).fat.toFixed(1)}g of fat</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).protein.toFixed(1)}g of protein</p>
                </div>
              </div>  
