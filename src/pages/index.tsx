        ...
        <div id="body" className="body">
          <BasketPanel total={basket.totalPrice}>
            ...
            <div className="panel insights">
              <ScorePanel score={overallHealthStar(basket.foodItems, filters)}/>

              <div className="insights__macros">
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).kj.toFixed(0)}kj of energy</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).sodium.toFixed(0)}mg of sodium</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).sugar.toFixed(0)}g of sugar</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).fat.toFixed(0)}g of fat</p>
                </div>
                ...
                <div>
                    ...
                    <p>{basketMacroSum(basket.foodItems, filters).protein.toFixed(0)}g of protein</p>
                </div>
              </div>  
